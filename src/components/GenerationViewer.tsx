				...
				{generatedImage && !isGenerating && (
					<div id="view-mode-buttons" className="flex bg-white shadow-3xs border border-brand-200/60 p-1 rounded-lg">
						<button
							...
							className={`p-1 px-2.5 rounded-md text-[10px] font-medium flex items-center gap-1.5 transition-colors cursor-pointer ${viewMode === "single"
						...
						<button
							...
							className={`p-1 px-2.5 rounded-md text-[10px] font-medium flex items-center gap-1.5 transition-colors cursor-pointer ${viewMode === "swipe"
									? "bg-brand-900 text-white"
									: "text-gray-500 hover:text-brand-900"
								}`}
						...
						<button
							...
							className={`p-1 px-2.5 rounded-md text-[10px] font-medium flex items-center gap-1.5 transition-colors cursor-pointer ${viewMode === "grid"
									? "bg-brand-900 text-white"
									: "text-gray-500 hover:text-brand-900"
								}`}
